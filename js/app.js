    ...
    async init() {
        try {
            ...
            const defaultForbidden = [
                ...
                {
                    name: '禁止不健康體型詞彙',
                    content: '預設嚴格禁止使用描述不健康體型的詞彙，包括：鎖骨、腰窩、膝彎、腰線、曲線、A4腰、漫畫腿、竹竿、紙片人、骨瘦如柴、瘦得皮包骨、皮包骨、肋骨、馬甲線、蝴蝶骨、骨感、纖瘦、苗條到不真實、過瘦、極瘦、超瘦、瘦削、纖細、盈盈一握、不堪一握、盈盈腰肢、纖腰、蜂腰、蛇腰、柳葉腰、水蛇腰、A4紙、iPhone腰、馬甲、蜜桃臀、鉛筆腿、筷子腿、火腿腸、樹枝、竹籤、竹竿腿、網紅腿、少女腿、小孩腿、蘿蔔腿、雞爪、骷髏、骷髏手、骷髏腿、瘦弱、瘦小、乾癟。這些是不符合正常健康人體的描述。例外：僅當使用者「主動、明確」表示希望使用過瘦體型描述時，才可使用上述詞彙。若使用者沒有主動開啟，則嚴格禁止。',
                    priority: 'front',
                    enabled: true
                },
                {
                    name: '尊重真實體型',
                    content: '角色必須嚴格閱讀並遵守使用者(user)的外觀描述和世界書中的身材設定。預設情況下，角色應描寫健康、正常的體型（有小腹、贅肉、自然曲線）。若使用者設定為較為圓潤、豐滿、健康體型，角色必須完全遵循該設定進行描述。僅當使用者「主動、明確」表示希望使用過瘦體型描述時，才可配合。每個人的身體都是獨特的，必須給予最大的尊重。',
                    priority: 'front',
                    enabled: true
                }
            ];
